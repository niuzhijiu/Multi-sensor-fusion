...
int main() {
    //定义路径
    std::string imu_csv = "/home/cat/20251030_cmake_test/imu0_data_w_norm.csv";
    std::string vis_csv = "/home/cat/20251030_cmake_test/visual_angular_velocity_mid_cpp.csv";
